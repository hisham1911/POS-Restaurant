...
namespace KasserPro.Infrastructure.Migrations
{
    ...
    [Migration("20260510220123_AddRestaurantFeatures")]
    partial class AddRestaurantFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<int>("KitchenPrintCount")
                        .HasColumnType("INTEGER");

                    b.Property<DateTime?>("LastKitchenPrintedAt")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("TableNumberSnapshot")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TenantId", "BranchId", "TableId")
                        .IsUnique()
                        .HasFilter("TableId IS NOT NULL AND OrderType = 0 AND Status IN (0,1) AND IsDeleted = 0");

                    b.HasIndex("TenantId", "BranchId", "OrderSource", "CreatedAt");

                    b.HasIndex("TenantId", "BranchId", "OrderSource", "ExternalOrderNumber")
                        .IsUnique()
                        .HasFilter("ExternalOrderNumber IS NOT NULL");

                    b.HasIndex("TenantId", "BranchId", "Status", "CompletedAt")
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<decimal>("KitchenPrintedQuantity")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<bool>("AutoDeductIngredients")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.RecipeIngredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.RestaurantTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("TenantId", "BranchId", "Status", "IsActive");

                    b.ToTable("RestaurantTables");
                });

            modelBuilder.Entity("KasserPro.Domain.Entities.SavedOrderNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.Shift", b =>
                {
                    ...
                    b.Property<decimal>("TotalBankAccount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.Property<bool>("AutoPrintDailyReports")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);

                    b.Property<bool>("AutoPrintOnDebtPayment")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(true);
                    ...
                    b.Property<string>("PrintRoutingMode")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(30)
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("KasserPro.Domain.Entities.RestaurantTable", "Table")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("KasserPro.Domain.Entities.OrderItem", "ParentOrderItem")
                        .WithMany("AddOns")
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("KasserPro.Domain.Entities.Wallet", "Wallet")
                        .WithMany()
            ...
            modelBuilder.Entity("KasserPro.Domain.Entities.RecipeIngredient", b =>
                {
                    b.HasOne("KasserPro.Domain.Entities.Product", "RawMaterial")
                        .WithMany()
                        .HasForeignKey("RawMaterialProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("KasserPro.Domain.Entities.Recipe", "Recipe")
