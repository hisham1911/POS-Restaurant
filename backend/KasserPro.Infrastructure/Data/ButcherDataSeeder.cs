...
public static class ButcherDataSeeder
{
    ...
    private static async Task<List<Product>> SeedProductsAsync(AppDbContext context, Tenant tenant, List<Category> categories)
    {
        ...
        {
            // لحوم بقري (Beef)
            new() { TenantId = tenant.Id, CategoryId = categories[0].Id, Name = "قراقيش", NameEn = "Qaraqish", Sku = "BEEF001", Barcode = "6291001001", Price = 25, Cost = 18, AverageCost = 18, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 10, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[0].Id, Name = "لحم قطع", NameEn = "Meat Cuts", Sku = "BEEF002", Barcode = "6291001002", Price = 380, Cost = 320, AverageCost = 320, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 15, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[0].Id, Name = "لحم ضلعه", NameEn = "Ribs", Sku = "BEEF003", Barcode = "6291001003", Price = 320, Cost = 270, AverageCost = 270, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 12, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[0].Id, Name = "لحم مميز", NameEn = "Premium Meat", Sku = "BEEF004", Barcode = "6291001004", Price = 400, Cost = 340, AverageCost = 340, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 15, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[0].Id, Name = "لحم دوش", NameEn = "Doush Meat", Sku = "BEEF005", Barcode = "6291001005", Price = 340, Cost = 290, AverageCost = 290, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 12, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[0].Id, Name = "لحم موزه", NameEn = "Mouza Meat", Sku = "BEEF006", Barcode = "6291001006", Price = 400, Cost = 340, AverageCost = 340, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 15, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[0].Id, Name = "لحم راس", NameEn = "Head Meat", Sku = "BEEF007", Barcode = "6291001007", Price = 225, Cost = 180, AverageCost = 180, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 10, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[0].Id, Name = "مكعبات لحم احمر", NameEn = "Red Meat Cubes", Sku = "BEEF008", Barcode = "6291001008", Price = 380, Cost = 320, AverageCost = 320, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 12, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[0].Id, Name = "استيك", NameEn = "Steak", Sku = "BEEF009", Barcode = "6291001009", Price = 450, Cost = 380, AverageCost = 380, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 8, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[0].Id, Name = "بوفتيك", NameEn = "Beefsteak", Sku = "BEEF010", Barcode = "6291001010", Price = 420, Cost = 360, AverageCost = 360, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 10, IsActive = true },

            // لحوم مفرومة ومصنعة (Minced & Processed)
            new() { TenantId = tenant.Id, CategoryId = categories[1].Id, Name = "كباب حله", NameEn = "Kebab Halla", Sku = "PROC001", Barcode = "6291002001", Price = 380, Cost = 320, AverageCost = 320, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 12, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[1].Id, Name = "كباب حله احمر", NameEn = "Red Kebab Halla", Sku = "PROC002", Barcode = "6291002002", Price = 380, Cost = 320, AverageCost = 320, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 12, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[1].Id, Name = "برجر", NameEn = "Burger", Sku = "PROC003", Barcode = "6291002003", Price = 250, Cost = 200, AverageCost = 200, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 15, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[1].Id, Name = "سجق مخصوص", NameEn = "Special Sausage", Sku = "PROC004", Barcode = "6291002004", Price = 300, Cost = 240, AverageCost = 240, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 15, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[1].Id, Name = "مفروم مخصوص", NameEn = "Special Minced", Sku = "PROC005", Barcode = "6291002005", Price = 300, Cost = 250, AverageCost = 250, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 15, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[1].Id, Name = "مزاليكا", NameEn = "Mazalika", Sku = "PROC006", Barcode = "6291002006", Price = 270, Cost = 220, AverageCost = 220, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 10, IsActive = true },

            // أحشاء ومنتجات ثانوية (Offal & By-products)
            new() { TenantId = tenant.Id, CategoryId = categories[2].Id, Name = "كوارع بالكيلو", NameEn = "Trotters per Kg", Sku = "OFFAL001", Barcode = "6291003001", Price = 180, Cost = 140, AverageCost = 140, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 8, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[2].Id, Name = "كوارع", NameEn = "Trotters", Sku = "OFFAL002", Barcode = "6291003002", Price = 280, Cost = 220, AverageCost = 220, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 7, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[2].Id, Name = "دهن طرب", NameEn = "Fat Tarab", Sku = "OFFAL003", Barcode = "6291003003", Price = 75, Cost = 50, AverageCost = 50, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 6, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[2].Id, Name = "حلويات", NameEn = "Sweetbreads", Sku = "OFFAL004", Barcode = "6291003004", Price = 130, Cost = 100, AverageCost = 100, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 5, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[2].Id, Name = "طحال", NameEn = "Spleen", Sku = "OFFAL005", Barcode = "6291003005", Price = 150, Cost = 120, AverageCost = 120, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 5, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[2].Id, Name = "ممبار", NameEn = "Mumbar", Sku = "OFFAL006", Barcode = "6291003006", Price = 260, Cost = 210, AverageCost = 210, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 6, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[2].Id, Name = "ام الشلاتيت", NameEn = "Um El-Shalatit", Sku = "OFFAL007", Barcode = "6291003007", Price = 140, Cost = 110, AverageCost = 110, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 5, IsActive = true },
            new() { TenantId = tenant.Id, CategoryId = categories[2].Id, Name = "دهن كلاوي", NameEn = "Kidney Fat", Sku = "OFFAL008", Barcode = "6291003008", Price = 75, Cost = 50, AverageCost = 50, TaxRate = 14, TaxInclusive = false, TrackInventory = true, LowStockThreshold = 6, IsActive = true }
        };
        ...
        foreach (var product in products)
        {
            foreach (var branch in branches)
            {
                branchInventories.Add(new BranchInventory
                {
                    ...
                    Quantity = 0, // Start with 0, will be updated by purchase invoices
        ...
        OrderStatus status, Branch branch)
    {
        ...
        if (status == OrderStatus.Completed)
        {
            ...
            var paymentMethod = _random.Next(10) < 7 ? PaymentMethod.Cash : PaymentMethod.BankAccount;
